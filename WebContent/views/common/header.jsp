            ...
            <div class="wrapper">
                <div id="H_menu" class="clearfix">
                    ...
                    <div id="H_nav">
                        ...
                        <li class="navi_set">
                            <a href="<%= request.getContextPath() %>/views/main/pet_hotelmain.jsp" class="topnav"><img src="<%= request.getContextPath() %>/resources/images/icons/pethotel.png" alt="pethotel"></a>
                            <ul class="subnav">
                                ...
                                <li><a href="<%= request.getContextPath() %>/views/main/hotelmain.jsp"><img src="<%= request.getContextPath() %>/resources/images/icons/sub_hotel.png" alt="반려견 동반 호텔"></a></li>
                            </ul>
                        </li>
                        <li class="navi_set">
