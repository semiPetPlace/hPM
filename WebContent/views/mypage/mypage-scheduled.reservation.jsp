    ...
    <body>
        ...
        <main id="H_main">
            ...
            <div id="showbox">
                <div id="innerNav">
                    <th>
                        <td><a href="<%=request.getContextPath() %>/scheduledReser.ys?userid=<%=m.getMuserId()%> " style="border-bottom: 3px solid #ffb600;">투숙예정 예약</a></td>
                    </th>
                    <th>
                            ...
                            <td class="guestRecode" style="width:70%">
                                <div id="showRecode">
                                    <ul>
    									...
    									<%if(rvm.getReserBreakfast().equals("have")){ %> <li>조식이 포함된 예약입니다.</li> <%} %>
                                    </ul>
                                </div>
                            </td>
