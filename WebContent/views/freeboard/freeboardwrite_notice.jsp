...
<link rel="stylesheet"
	href="<%=request.getContextPath()%>/resources/css/freeboardwrite.css">
...
<body>
	...
	<div id="main">
		...
		<form action="<%=request.getContextPath()%>/nInsert.th"
			...
			<div class="review_content">
				<div>
					<input type="text" name="title" id="post-name"
						placeholder="제목을 작성해 주세요." />
				</div>
				<div id="write_menu">
					<input type="file" name="file" id="file"
						style="border: 1px solid black; margin-top: 5px; width: 100%" />
				</div>
