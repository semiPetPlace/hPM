...
<head>
    ...
    <link rel="stylesheet" href="../../resources/css/cafe-detail.css">
        ...
        <div class="wrapper cafe-cont clearfix">
            <div class="left">
                    ...
                    <div class="small-box">
                        <ul class="slides">
                            ...
                            <li class="slide-container">
                                ...
                                <div class="slide">
                                    <img src="https://images.mypetlife.co.kr/map/content/uploads/2019/05/06230524/KakaoTalk_Moim_4AWlBQu0MIdS4z9cheGIreazGTaSR3-1024x800.jpg" />
                                </div>
                            </li>
                            ...
                            <li class="slide-container">
                                <div class="slide">
                                    <img src="https://images.mypetlife.co.kr/map/content/uploads/2019/05/06230523/KakaoTalk_Moim_4AWlBQu0MIdS4z9cheGIreazGTrEWd-768x1024.jpg" />
                                </div>
                                <div class="nav">
                            ...
                            <li class="slide-container">
                                <div class="slide">
                                    <img src="https://images.mypetlife.co.kr/map/content/uploads/2019/05/06230523/KakaoTalk_Moim_4AWlBQu0MIdS4z9cheGIreazGTuXxT-1024x768.jpg" />
                                </div>
                                <div class="nav">
                            ...
                            <li class="slide-container">
                                <div class="slide">
                                    <img src="https://images.mypetlife.co.kr/map/content/uploads/2019/05/06230522/lemon-1024x680.png" />
                                </div>
                                <div class="nav">
                            ...
                            <li class="slide-container">
                                <div class="slide">
                                    <img src="https://images.mypetlife.co.kr/map/content/uploads/2019/05/06230523/KakaoTalk_20180728_222128842-1024x768-768x576.jpg" />
                                </div>
                                <div class="nav">
                ...
                <div class="review">
                    ...
                    <div class="content">
                        <ul class="list">
                            <li>“ 사장님도 넘 친절하고 넘 좋아요 최고 행복해 브런치도 맛있어용 꿀떡이랑 행복한 시간이였어요~~ ”</li>
            ...
            <div class="right">
                ...
                <div class="time">
                    ...
                    <div class="t_cont">
                        <ul>
                            <li>월요일 10:00 - 21:00</li>
                            <li>화요일 10:00 - 21:00 (둘째주 휴무)</li>
                            <li>수요일 10:00 - 21:00</li>
                            <li>목요일 10:00 - 21:00</li>
                            <li>금요일 09:00 - 22:00</li>
                            <li>토요일 09:00 - 22:00</li>
