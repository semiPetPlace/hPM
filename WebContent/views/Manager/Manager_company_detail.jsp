        ...
        <div class="main-content">
            ...
            <div class="content">
                <div class="reservationTable">
                    <p style="font-size: 30px; font-weight: 500px; margin-bottom: 10px;">업체 상세</p>
                    ...
                    <div class="btns">
                        <input type="button" value="목록으로" class="preBtn" onclick="location.href='cList.co'">
                        <input type="submit" value="내용 수정" class="subBtn" onclick="location.href='cEditView.co?comNum=<%=c.getComNum()%>'">
                    </div>
                    </div>
                </div>
            </div>
