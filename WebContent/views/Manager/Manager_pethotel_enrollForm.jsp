...
<%
	PetHotel h = (PetHotel)request.getAttribute("petHotel");
%>
<!DOCTYPE html>
<html lang="ko">
<head>
...
<main id="main">
                   		...
                   		<form id="erollForm" action="${pageContext.request.contextPath}/hEnroll.hj" method="post" enctype="multipart/form-data">
	                        <table border="1"  id="insertTable">
	                            ...
	                            <tr>
	                                <th>호텔 명</th>
	                                <td>
	                                    <input type="text" name="phname" id="phname" placeholder="호텔명" required="required" autofocus>
	                                </td>
	                            </tr>
								<tr>
									<th>주소지</th>
	                            ...
	                            <tr>
	                                ...
	                                <td>
	                                    <textarea name="phpromotion" id="phpromotion" placeholder="업체 홍보글 입력 칸 입니다."></textarea>
	                                </td>
	                            </tr>
	                            <tr>
	                                <th style="vertical-align:top;">요청사항</th>
	                                <td>
	                                    <textarea name="phrequests" id="phrequests" placeholder="업체 요청사항 입력 칸 입니다."></textarea>
	                                </td>
	                            </tr>
	                            <tr>
	                                <th>호텔 이미지</th>
	                            ...
	                            <tr>
	                                <th>등록 일</th>
	                                <td>
	                                    <input type="date" name="phregisterdate" id="phregisterdate" style="margin:5px auto;">
	                                </td>
	                            </tr>
	                            <tr>
									<th>등록 여부</th>
    ...
    /* var cnt = 1; */
	    ...
	    function enrollCompany() {
			alert('등록이 완료되었습니다. ');
			/* $("#enrollForm").submit(); */
			$("#enrollForm").attr("action","<%= request.getContextPath()%>/phEnroll.hj");
		}
