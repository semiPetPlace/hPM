...
<html lang="en">
    <head>
        ...
        <link rel="stylesheet" href="../../resources/css/hotel_payment.css">
        ...
        <div class="main">
            ...
            <div class="left-block">
                ...
                <div id="refund">
                    ...
                    <p style="float:right; margin-top:13px;margin-right:10px">&#8361;180,400</p>
                </div>
                <div id="include">
                    <div class="title">
            ...
            <div class="main-block">
                <div id="hotel-info">
                    <div id="hotelimg"><img src="../../resources/images/hotel2.jpg" alt=""></div>
                    <div id="hoteltext">
                        <div class="hotelname">호텔이름</div>
                        <div style="float: right;background:navy;width: 70px; height:50px;">
                            <p style="font-size: 16px; color: rgb(255, 240, 197); font-weight: bold;margin-top: 16px;">평점9.8</p>
                        </div>
                        ...
                        <div class="address"><img src="../../resources/images/icons/location.png" width="20px" alt="깃발표시">서울 역삼역</div>
                    </div>
                </div>
                ...
                <div id="client-input">
                    <div class="travltype">
                        ...
                        <label for="totrable"> <input type="radio" name="forwhat" id="totrable"> 여행 및 관광</label>
                        <label for="tobusiness"> <input type="radio" name="forwhat" id="tobusiness"> 출장 및 비지니스</label>
                    </div>
                    <div class="personaldata">
                        ...
                        <div class="email">
                            ...
                            <div class="input-email">
                                <p>이메일 주소 확인</p>  
                                <input type="email" name="" id="emailchk">
                            </div>
                        </div>
                        <div class="forwho">
                                <span>본인을 위한 예약인가요?</span><br>
                                <label for="me"> <input type="radio" name="forwho" id="me"> 대표 투숙객: 본인</label><br>
                                <label for="other"> <input type="radio" name="forwho" id="other"> 다른 사람을 대신하여 예약함</label>
                        </div>
                        <hr>
                        <div class="sub-block">
                            <span id="roomtype">스탠다드 더블룸 - 서울의 대부분의 객실보다 넓음</span>
                            <p id="price"> &#8361;180,400</p><p id="day">(1박)</p>
                            <p><a href="">환불 불가</a></p>
                            <div class="facility-box">
                                <div class="facility"><img src="../../resources/images/icons/cityview.png" alt=""> <span>도시 전망</span></div>
                                <div class="facility"><img src="../../resources/images/icons/air-conditioner.png" alt=""><span>에어컨</span></div>
                                <div class="facility"><img src="../../resources/images/icons/bathroom.png" alt=""><span>전용 욕실</span></div>
                                <div class="facility"><img src="../../resources/images/icons/mute.png" alt=""><span>방음 시설</span></div>
                            </div>
                            <div class="headcount">
                            ...
                            <div class="clientname">
                                <p>투숙객 성명</p>
                                <input class="inputbox" type="text" name="fullname" id="">
                            </div>
                        </div>
                    </div>
                ...
                <div id="btn-block">
                    <input id="test1" type="submit" value="다음 단계 >">
                    <p>예약 완료시 주소로 예약 확인서가 바로 전송됩니다. </p>
                </div>
                <script>
                    $('#test1').click(function(){
                        $('#fm1').attr('action','file:///C:/Users/CHOHEE/Desktop/%EC%BD%94%EB%94%A9/HTMLworkspace/SEMI/semiproject_810/views/hotel/hotel_finishedReservation.jsp').submit();
                    });
                </script>
