        ...
        <div id="main-wrapper">
         ...
         <div class="wrapper2">
            ...
            <form action="search.ho" id ="search" method="post">
	            <div id="search-box">
	                <select name="place" id="" style="font-size: 1.4rem; width: 200px; text-align: center; margin-right: 90px; margin-left: 70px; border: none;">
	                    ...
	                    <option value="cafe&restaurant">반려견 카페·레스토랑</option> 
	                </select>
	                <input type="date" class="check" name="checkin" style="font-size: 1.4rem; width: 180px; border: none;">
	                <input type="date" class="check" name="checkout" style="font-size: 1.4rem; width: 180px; margin-right: 95px; border: none;">
	                <select name="area" id="" style="font-size: 1.4rem; width: 180px; text-align: center; margin-right: 150px; border: none;">
    ...
    <%-- <script>
    	function searching(){
    		location.href="<%=request.getContextPath()%>
    			/search.main?Place=place&Checkin=checkin&Checkout=checkout&Area=area;"
    	}
    </script> --%>
    </body>
</jsp>