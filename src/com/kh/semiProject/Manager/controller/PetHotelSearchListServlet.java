...
/**
 * Servlet implementation class PetHotelSearchListServlet
 */
@WebServlet("/phSearchList.hj")
public class PetHotelSearchListServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public PetHotelSearchListServlet() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		// 검색 카데고리
				...
				String page = "";
				ArrayList<PetHotel> list = new ArrayList<>();
				...
				if(categorySearch.equals("total")) {
					list = ms.listpetHotel(currentPage, limit);
				} else {
					list = ms.searchpetHotel(currentPage, limit,categorySearch,keyword);
				}
				
				System.out.println(list);
				if(list != null) {	// 조회 성공 시
					page = "views/Manager/Manager_pethotel_list.jsp";
