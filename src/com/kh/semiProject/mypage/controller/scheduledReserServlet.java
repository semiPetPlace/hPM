...
/**
 * Servlet implementation class scheduledReserServlet
 */
@WebServlet("/scheduledReser.ys")
public class scheduledReserServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public scheduledReserServlet() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		reserList = srs.scheduledreser(userid);
		
		System.out.println(userid);
		System.out.println(reserList);
		String page = "";
		if(!reserList.isEmpty()) {
			page = "views/mypage/mypage-scheduled.reservation.jsp";
