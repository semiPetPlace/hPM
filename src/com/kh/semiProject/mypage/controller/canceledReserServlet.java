...
/**
 * Servlet implementation class canceledReserServlet
 */
@WebServlet("/canceledReser.ys")
public class canceledReserServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public canceledReserServlet() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		reserList = srs.canceledReser(userid);
		
		System.out.println(userid);
		System.out.println(reserList);
		String page = "";
		if(!reserList.isEmpty()) {
			page = "views/mypage/mypage-canceled.reservation.jsp";
